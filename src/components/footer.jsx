...
const textArray = ["Interior Design", "Amazing Residential", "City Marks", "NEW DESIGN?"];
...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-black text-white min-h-[60vh] md:min-h-[90vh]  sm:min-h-[70vh] sm:px-4 flex flex-col items-center">
      ...
      <div className="flex-grow flex flex-col items-center justify-center text-center mt-0">
        ...
        <div ref={ref} className="relative overflow-hidden mt-0 h-28 sm:h-56 w-full flex justify-center items-center">
          <motion.h2
  ...
  <BoxItem text="EXPERTS" widths="w-24 sm:w-28 md:w-28 lg:w-28" heights="h-8 sm:h-8 md:h-10 lg:h-10" />
  <BoxItem text="PRICING" widths="w-24 sm:w-28 md:w-28 lg:w-28" heights="h-8 sm:h-8 md:h-10 lg:h-10" />
  <BoxItem text="BEST SERVICE" widths="w-32 sm:w-32 md:w-36 lg:w-36" heights="h-8 sm:h-8 md:h-10 lg:h-10" />
    ...
    />
      ...
      <div className="w-full flex justify-between items-center mt-8 sm:mt-8 mb-4 sm:mb-4 flex-col sm:flex-row">
        ...
        <div className="text-base text-gray-400 text-center sm:text-right mb-4 sm:mb-0">
          <p>&copy; Decor. All Rights Reserved. Licensing</p>
        </div>
